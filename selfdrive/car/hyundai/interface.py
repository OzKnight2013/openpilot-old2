...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=[]):
    ...
    ret.longitudinalTuning.kpV = [.8, .5, .5]
    ret.longitudinalTuning.kiBP = [0., 15., 35.]
    ret.longitudinalTuning.kiV = [.08, .06, .06]
    ret.longitudinalTuning.deadzoneBP = [0., 5.,  40.]
    ret.longitudinalTuning.deadzoneV = [0.2, 0.2, 0.3]
    ret.gasMaxBP = [0., .2, 3., 40]
    ret.gasMaxV = [.005, .1, .125, .1]
