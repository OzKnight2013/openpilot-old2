...
class Controls:
    ...
    def update_events(self, CS):
        ...
        if self.sm['pathPlan'].laneChangeBSM == LaneChangeBSM.left:
            self.events.add(EventName.leftLCAbsm)
        if self.sm['pathPlan'].laneChangeBSM == LaneChangeBSM.right:
            self.events.add(EventName.rightLCAbsm)
    ...
    def state_control(self, CS):
        ...
        # Gas/Brake PID loop
        actuators.gas, actuators.brake = self.LoC.update(self.active, CS, v_acc_sol, plan.vTargetFuture, a_acc_sol,
                                                         self.CP)
    ...
    def publish_logs(self, CS, start_time, actuators, v_acc, a_acc, lac_log):
        ...
        CC.cruiseControl.accelOverride = self.CI.calc_accel_override(CS.aEgo, self.sm['plan'].aTarget, CS.vEgo,
                                                                     self.sm['plan'].vTarget)
